...
public class Street extends Feld {
	...
	public Street(int id, String name, int gruppenId, int kaufPreis, int miete,
			int mieteHaus, int mieteHaus2, int mieteHaus3, int mieteHaus4,
			int mieteHotel) {
		super();
		this.id = id;
		this.typ = "street";
	...
	public int getPreisHaus() {
		return preisHaus;
	}

	public void setPreisHaus(int preisHaus) {
		this.preisHaus = preisHaus;
	}
